    ...
    <div id="reserve">
        <div class="title_block">
            <div class="left_block">
                <div class="title">预约实验</div>
                <el-select v-model="nowType" :placeholder="devices[nowType].name">
        ...
        <div class="table_block">
            <el-table :data="reserveData" border :cell-class-name="setColor" @cell-click="reserve">
...
.el-table .reserveClose, .el-table .reserveAvailable{
    cursor: pointer;
}
