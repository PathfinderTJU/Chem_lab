...
export default{
    ...
    methods: {
        ...
        submitAbosrption(){
            ...
            fetch(this.URL + "api/resources/init_xssj_close_params", {
                method: 'POST',
                headers: {
        ...
        submitConduct(){
            ...
            fetch(this.URL + "api/resources/init_crsj_close_params", {
                method: 'POST',
                headers: {
					Authorization: 'Bearer  ' + localStorage.getItem("token"),
					'Content-Type': 'application/json'
        ...
        submitFlow(){
            ...
            fetch(this.URL + "api/resources/init_ltsj_close_params", {
                method: 'POST',
                headers: {
					Authorization: 'Bearer  ' + localStorage.getItem("token"),
					'Content-Type': 'application/json'
        ...
        submitRectification(){
            ...
            fetch(this.URL + "api/resources/init_jlsj_close_params", {
                method: 'POST',
                headers: {
					Authorization: 'Bearer  ' + localStorage.getItem("token"),
					'Content-Type': 'application/json'
        ...
        // 获取初始值列表数据
        getInitData(){
            fetch(this.URL + "api/resources/get_all_close_params", {
                method: "GET",
                headers: {
					Authorization: 'Bearer  ' + localStorage.getItem("token")
				}
